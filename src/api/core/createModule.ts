...
export interface ApiModuleDefinition<TParams, TResult> {
...
export function createApiModule<TParams = void, TResult = void>(definition: ApiModuleDefinition<TParams, TResult>) {
